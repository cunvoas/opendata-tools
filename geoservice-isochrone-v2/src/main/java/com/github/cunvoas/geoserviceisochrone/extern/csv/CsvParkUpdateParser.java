...
/**
 * Parseur CSV pour l'import et la mise à jour des parcs.
 * Permet de lire un fichier CSV et de générer des objets de mise à jour de parc.
 * @author cunvoas
...
public class CsvParkUpdateParser {
    /**
     * Enumération des entêtes du CSV pour la mise à jour des parcs.
    ...
    /**
     * Parse un fichier CSV contenant les mises à jour de parcs.
     * @param csvFile le fichier CSV à parser
     * @return la liste des objets CsvParkUpdate lus
