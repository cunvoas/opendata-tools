...
/**
 * Analyseur de fichiers CSV pour les jardins familiaux de Roubaix.
 * Permet d'extraire les informations des jardins à partir d'un fichier CSV.
...
public class CsvRbxJardinFamilleParser {
	...
	/**
	 * Analyse le fichier CSV fourni et retourne la liste des jardins familiaux extraits.
