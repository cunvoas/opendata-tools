INSERT INTO public.park_type(id, i18n, oms) VALUES (0, 'park.type.unknown', false);
...
UPDATE public.park_area SET type_id=5 WHERE id_parc_jardin in (
    SELECT identifiant FROM public.parc_jardin WHERE sous_type='Place' );
