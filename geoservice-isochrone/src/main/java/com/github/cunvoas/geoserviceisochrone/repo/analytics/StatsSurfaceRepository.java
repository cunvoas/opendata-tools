...
public interface StatsSurfaceRepository extends ReadOnlyRepository<StatsSurface, StatsSurfaceId> {
	...
	final String QRY_CITY = "WITH surface_range AS (\n"
			+ "	select 0 as surface_min, 3 as surface_max UNION\n"
			+ "	select 3 as surface_min, 7 as surface_max UNION\n"
			+ "	select 7 as surface_min, 10 as surface_max UNION\n"
			+ "	select 10 as surface_min, 12 as surface_max UNION\n"
	...
	final String QRY_SUBURBS = "WITH surface_range AS (\n"
			+ "	select 0 as surface_min, 8 as surface_max UNION\n"
			+ "	select 8 as surface_min, 17 as surface_max UNION\n"
			+ "	select 17 as surface_min, 25 as surface_max UNION\n"
			+ "	select 25 as surface_min, 45 as surface_max UNION\n"
