<template>
  <div id="app" valign="top" align="left">
      <b-container>
        <b-row>
          <b-col>
            <img
      ...
      <span style="border: 2px" >
          <div id="map" align="center" valign="middle" style="position: relative, z-index: 10;">
    ...
    <span id="legend">
      ...
      <tbody>
        ...
        <tr>
          <td style="background: linear-gradient(to right, #7c7c7c, #e0e0e0)">&lt; 10 m²/habitant (&lt; 25 m²/hab à la campagne)</td>
        </tr>
        <tr>
...
.dataDetail { padding: 6px 8px; font: 16px/18px Arial, Helvetica, sans-serif; background: white; background: rgba(255,255,255,0.9); box-shadow: 0 0 15px rgba(0,0,0,0.2); border-radius: 5px; } 
.dataDetail h4 { margin: 0 0 5px; color: #777; }
